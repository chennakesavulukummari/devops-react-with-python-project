...
# Simple API Gateway for C3Ops Typeform
set -e
...
# Step 7: Create POST method for submit with CORS
...
# Step 9: Set up Lambda integrations
...
# Step 10: Give API Gateway permission to invoke Lambda functions
aws lambda add-permission \
    ...
    --source-arn "arn:aws:execute-api:$REGION:$ACCOUNT_ID:$API_ID/*/*" >/dev/null 2>&1 || echo "Permission may already exist"
...
echo ""
echo "⚠️  Next Step: Update your frontend with this API URL"
echo "Replace API_BASE_URL in TypeformModal.jsx with: $API_URL"
echo ""
echo "🧪 Test commands:"
echo "# Test submit endpoint:"
echo "curl -X POST $API_URL/api/typeform/submit \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -d '{\"email\":\"test@example.com\",\"company\":\"Test Corp\",\"currentSpend\":\"10000\",\"challenges\":[\"cost-visibility\"],\"timeline\":\"1-3-months\",\"contact_method\":\"email\",\"additional_info\":\"Test submission\"}'"
echo ""
echo "# Test get endpoint:"
echo "curl -X GET $API_URL/api/typeform/submissions"